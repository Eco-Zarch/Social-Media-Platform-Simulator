...
public class UserTest {
	...
	public void rateMemeTest() {
		...
		assertEquals(rating, meme.getRatings()[0]);
	}
	...
	@Test
	public void rateNextMemeFromFeedTestv2() {
		Feed feed1 = new Feed();
		User Peter = new User("Peter");
		BackgroundImage image1 = new BackgroundImage("x", "y", "z");
	    BackgroundImage image2 = new BackgroundImage("x", "y", "z");
		...
		assertFalse(myUser.rateNextMemeFromFeed(feed1, 1));
	}
	...
	public void toStringTest() {
	    ...
	    assertEquals(myUser.toString(), "null has rated (0) memes, (1.0)");
	}
